<div id="pad-wrapper" class="new-user">
    ...
    <div class="row form-wrapper">
        <div class="col-md-12 ">
            ...
            <?php echo form_open('', array('class'=>'form-horizontal'), array('id' => $article->id)); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php echo form_input(array(
                        'name' => 'slug',
                        'id' => 'slug',
                        'value' => set_value('slug', $article->title),
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php echo form_textarea(array(
                        'name' => 'short_text',
                        'id' => 'short_text',
                        'value' => set_value('short_text', $article->short_text),
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php echo form_textarea(array(
                        'name' => 'full_text',
                        'id' => 'full_text',
                        'value' => set_value('full_text', $article->full_text),
                        'class' => 'form-control editor',
                        'rows' => 5,
                ...
                <div class="col-md-10">
                    <select id="category_id" class="select2" name="category_id" class="form-control">
                        ...
                        <?php foreach($categories as $category):
                            $selected = $category->id == $article->category_id ? TRUE : FALSE; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 ctrls">
                    <div class="slider-frame">
                        ...
                        <?php echo form_hidden('published', set_value('published', $article->published)); ?>
                    </div>
