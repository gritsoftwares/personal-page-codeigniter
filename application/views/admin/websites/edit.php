<div id="pad-wrapper" class="new-user">
    ...
    <div class="row form-wrapper">
        <div class="col-md-12 ">
            ...
            <?php echo form_open('', array('class'=>'form-horizontal'), array('id' => $website->id)); ?>
                ...
                <div class="col-md-10">
                    <select id="website_id" class="select2" name="website_id" class="form-control">
                        ...
                        <?php foreach($social_nets as $net):
                            $selected = $net->title == $website->title ? TRUE : FALSE; ?>
                            <option value="<?php echo $net->id; ?>" <?php echo set_select('website_id', $net->id, $selected); ?>><?php echo $net->title; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php echo form_input(array(
                        'name' => 'account',
                        'id' => 'account',
                        'value' => set_value('account', $website->account),
                        'class' => 'form-control',
