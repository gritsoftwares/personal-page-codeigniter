                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="field-box">
                                    ...
                                    <input id="start_date" name="start_date" class="form-control input-datepicker" type="text" data-date-minviewmode="months" data-date-viewmode="years" data-date-format="mm/yyyy" value="<?php echo timestamp_to_date(set_value('start_date', date_to_timestamp('01/2012'))); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="field-box">
                                    <label>End date:</label>
                                    <input id="end_date" name="end_date" class="form-control input-datepicker" type="text" data-date-minviewmode="months" data-date-viewmode="years" data-date-format="mm/yyyy" value="<?php echo timestamp_to_date(set_value('end_date', date_to_timestamp('01/2013'))); ?>">
